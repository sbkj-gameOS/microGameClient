(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/module/majiang/js/setting/SettingClide.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'acf49Qcda1OaKZe6CSWk9RI', 'SettingClide', __filename);
// module/majiang/js/setting/SettingClide.js
...
cc.Class({
    ...
    //     this.soundoff.active =  false;
    // },
    onSoundBtnClick: function onSoundBtnClick() {
    ...
    dnajiClick: function dnajiClick() {
        if (cc.beimi.click == 1) {
            this.danji.active = false;
            this.shuangji.active = true;
            cc.beimi.click = 2;
    ...
    cardClick: function cardClick(event) {
    ...
    cardonload: function cardonload() {
