(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/module/majiang/js/setting/SummaryClick.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'e2ad9JXL4FEGqsIinwW8Krh', 'SummaryClick', __filename);
// module/majiang/js/setting/SummaryClick.js
...
cc.Class({
    ...
    init: function init() {
        ...
        if (userInfo.playOvers) {
            ...
            var lose = false;
            var liuju = void 0;
            for (var _i = 0; _i < userInfo.playOvers.length; _i++) {
                var list = cc.instantiate(this.list);
                list.getComponent('EndCards').setData(userInfo.playOvers[_i]);

                list.parent = this.layout;
                if (userInfo.playOvers[_i].win == false) {}
                if (userInfo.playOvers[_i].user == cc.weijifen.user.id) {
                    if (userInfo.playOvers[_i].win == true) {
                        this.win.active = true;
                    } else if (userInfo.playOvers[_i].count < 0) {
    ...
    init2: function init2() {
        ...
        if (userInfo.players) {
            ...
            var liuju = void 0;
            var count = 0;
            for (var i = 0; i < userInfo.players.length; i++) {
    ...
    dayingjia: function dayingjia(counts, inx) {
        var zhen = true;
        var count = this.data.players[inx][counts];
    ...
    setDataEnd: function setDataEnd(data) {
