(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/module/majiang/js/roomInit/RoomInit.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'd1d18Qqw+NMaqEok1q9zrHN', 'RoomInit', __filename);
// module/majiang/js/roomInit/RoomInit.js
...
cc.Class({
        ...
        joinroom_event: function joinroom_event(data, context) {
            ...
            if (cc.weijifen.playerNum == 2) {
                ...
                if (data.id != cc.sys.localStorage.getItem('current') && data.id != cc.sys.localStorage.getItem('right') && data.id != cc.sys.localStorage.getItem('top')) {
                    ...
                    var playerarray = context.playersarray;
                    if (playerarray) {
                        for (var _i = 0; _i < playerarray.length; _i++) {
                            var playerinfo = playerarray[_i].getComponent('MaJiangPlayer');
                            var tablepos = playerinfo.tablepos;
                            var on_off_line = playerinfo.on_off_line;
                            var headimg = playerinfo.headimg;
                            if (data.id == playerinfo.data.id) {
                ...
                if (data.id != cc.sys.localStorage.getItem('current') && data.id != cc.sys.localStorage.getItem('right') && data.id != cc.sys.localStorage.getItem('left') && data.id != cc.sys.localStorage.getItem('top')) {
                    ...
                    var playerarray = context.playersarray;
                    if (playerarray) {
                        for (var _i2 = 0; _i2 < playerarray.length; _i2++) {
                            var playerinfo = playerarray[_i2].getComponent('MaJiangPlayer');
                            var tablepos = playerinfo.tablepos;
                            var on_off_line = playerinfo.on_off_line;
                            var headimg = playerinfo.headimg;
                            if (data.id == playerinfo.data.id) {
    ...
    onClick: function onClick(event) {
        ...
        var mjdata = cc.find('Canvas').getComponent('MJDataBind');
...
cc._RF.pop();
        ...
        //# sourceMappingURL=RoomInit.js.map
