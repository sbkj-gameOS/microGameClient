(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/module/majiang/js/gameOver/GameOver.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'eaf79pgcN1EfYxKJgyn+3pK', 'GameOver', __filename);
// module/majiang/js/gameOver/GameOver.js
...
cc.Class({
				...
				statics: {
								allcards_event: function allcards_event(data, context) {
												...
												for (var i = 0; i < data.playOvers.length; i++) {
												...
												setTimeout(function () {
																context.endList(data, context, playerid);
												}, 3000);
								},
								huaction: function huaction(playerid) {
												var gameOverNode = cc.find('Canvas/js/GameOver').getComponent('GameOver');
												var gameStartInit = require('GameStartInit');
												if (playerid) {
																// cc.beimi.audio.playSFX('nv/hu.mp3');                    
																var hu_hu = gameOverNode.current_hu.getComponent(cc.Animation);
																var player = gameStartInit.player(playerid, this);
																var action = cc.scaleTo(1.5, 1.5);
																...
																var ani = gameOverNode.current_hu.getComponent(cc.Animation);
																ani.play("current_hu");
												} else {
																gameOverNode.liuju.active = true;
												}
								},
								huaction2: function huaction2(playerid) {
												var gameStartInit = require('GameStartInit');
												var ani = gameOverNode.current_hu.getComponent(cc.Animation);
