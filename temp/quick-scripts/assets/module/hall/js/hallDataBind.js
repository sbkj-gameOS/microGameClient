(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/module/hall/js/hallDataBind.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'fb566ee9PJCvaohyw/5Rbiz', 'hallDataBind', __filename);
// module/hall/js/hallDataBind.js
...
cc.Class({
    ...
    carderror: function carderror(result, object) {
        // this.alert('充值失败');
    },
    cardsucess: function cardsucess(result, object) {
    ...
    tzsucess: function tzsucess(result, object) {
        var data = JSON.parse(result);
        if (data.tz) {
            object.hall(3);
        }
    },
    tzerror: function tzerror(result, object) {},
    ...
    //滚动公告字幕
    gundongText: function gundongText() {
        //debugger
        var self = this;
        var text = self.message;
        var width = self.message.node.parent.width;
        text.node.runAction(cc.repeatForever(cc.sequence(cc.moveTo(text.node.width / width * 10, cc.p(-text.node.width - width / 5, text.node.y)), cc.callFunc(function () {
            text.node.x = width;
        }))), 1000);
    },
    //创建包厢
    ...
    //加入包厢
    joinInRoom: function joinInRoom() {
        this.hall(10);
        /*if(cc.weijifen.room !='null' &&cc.weijifen.room != null){
...
cc._RF.pop();
        ...
        //# sourceMappingURL=hallDataBind.js.map
